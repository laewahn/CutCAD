...
public class Tenon 
{
  ...
  private boolean extr1start, extr1end;
...
//ToDO extr1start, extr1end per ....containsPoint()
  //public Tenon(Edge edge1, Edge edge2, )
  {
    this.angle = angle;
...
//    out.println("x:" + modT0intr.x() + " y:" + modT0intr.y());
...
//    out.println("Base Intrusion: x:" + modT0intr.x() + " y:" + modT0intr.y());
//    out.println("Base Extrusion: x:" + modT0extr.x() + " y:" + modT0intr.y());
...
//    out.println("Mod Intrusion x:" + modT0intr.x() + " y:" + modT0intr.y());
//    out.println("Mod Extrusion x:" + modT0extr.x() + " y:" + modT0intr.y());
...
//    out.println("Resized Intrusion x:" + modT0intr.x() + " y:" + modT0intr.y());
//    out.println("Resized Extrusion x:" + modT0extr.x() + " y:" + modT0intr.y());
